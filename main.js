...
const translations = {
  tr: {
    ...
    'home.prodSemiTubularRivetsDesc': 'Montaj kolaylığı sağlayan çizime uygun yarım delikli ve kademeli delikli perçin imalatı.',
    'home.prodTubularRivetsDesc': 'Hafif ve içi boş geçişler için yüksek kaliteli tam delikli boru perçin imalatı.',
    ...
    'products.tabTubularRivets': 'Delikli Perçinler',
    ...
    'products.hexMaterialVal': 'DIN 931, DIN 933, ISO 4014, ISO 4017 (Sınıf 8.8, 10.9, 12.9)',
    ...
    'products.solidMaterials': 'Paslanmaz Çelik (304, 316), Alüminyum, Bakır, Karbon Çeliği',
    'products.solidSizes': 'Çap: M3 - M11 (3mm - 11mm), Boy: 5mm - 80mm',
    'products.solidSpecOps': 'Kademeli kafa/gövde dövme, konik dövme, kafa markalama ve korozyon önleyici kaplama',
    ...
    'products.semiTubularRivetsItem2': 'Kademeli Yarım Delikli Perçinler',
    'products.semiTubularMaterials': 'Paslanmaz Çelik, Alüminyum, Pirinç, Bakır, Yumuşak Çelik (SAE 1006/1010 vb.)',
    'products.semiTubularSizes': 'Çap: M3 - M10 (3mm - 10mm), Delik Derinliği: Standart veya çizime özel',
    'products.semiTubularSpecOps': 'Yarım delik dövme presleme, havşa delik işleme, kademeli delik delme',
    'products.tubularRivetsTitle': 'Delikli Perçinler',
    'products.tubularRivetsDesc': 'İçi tamamen boş (boru şeklinde) olan ve yüksek montaj esnekliği sağlayan perçinlerdir. Hafif montajlar, deri, plastik, baskılı devre kartları ve menteşe birleşimlerinde kullanılır.',
    'products.tubularRivetsItem1': 'Tam Delikli Boru Perçinler (DIN 7338 Tip B/C)',
    'products.tubularRivetsItem2': 'Özel Delikli Kovan ve Burç Parçaları',
    'products.tubularMaterials': 'Paslanmaz Çelik, Alüminyum, Pirinç, Bakır, Çelik',
    'products.tubularSizes': 'Çap: M3 - M8 (3mm - 8mm), Boy: 4mm - 50mm',
    'products.tubularSpecOps': 'Boru şeklinde delikli presleme, ikincil hassas iç delik açma, kanal açma',
    ...
    'quality.p1': 'Özperçin Cıvata Sanayi olarak, sıfır hata felsefesine yakın bir tolerans hassasiyeti ile çalışmaktayız. Üretilen tüm standart cıvata ve perçin gruplarının yanı sıra, özel üretim parçalarda da uluslararası standartların (DIN, ISO) öngördüğü normları eksiksiz karşılamaktayız.',
    ...
    'quality.machine3': 'Akma ve Sertlik Ölçüm Analizi',
    'quality.machine3Desc': 'Bilgisayar destekli grafik analiz yazılımı ile test verilerinin gerçek zamanlı takibi ve sertlik raporlaması.',
  ...
  en: {
    ...
    'home.prodSemiTubularRivetsDesc': 'Manufacturing of custom semi-tubular and shouldered hollow rivets for easy assembly.',
    'home.prodTubularRivetsDesc': 'Manufacturing of high-quality full tubular/hollow pipe rivets for lightweight and hollow joints.',
    ...
    'products.tabTubularRivets': 'Tubular Rivets',
    ...
    'products.hexMaterialVal': 'DIN 931, DIN 933, ISO 4014, ISO 4017 (Class 8.8, 10.9, 12.9)',
    ...
    'products.solidMaterials': 'Stainless Steel (304, 316), Aluminum, Copper, Carbon Steel',
    'products.solidSizes': 'Diameter: M3 - M11 (3mm - 11mm), Length: 5mm - 80mm',
    'products.solidSpecOps': 'Shoulder body/head forging, conical heading, head marking, and anti-corrosion coating',
    ...
    'products.semiTubularRivetsItem2': 'Shouldered Semi-Tubular Rivets',
    'products.semiTubularMaterials': 'Stainless Steel, Aluminum, Brass, Copper, Mild Steel (SAE 1006/1010 etc.)',
    'products.semiTubularSizes': 'Diameter: M3 - M10 (3mm - 10mm), Hole Depth: Standard or custom to drawing',
    'products.semiTubularSpecOps': 'Semi-tubular cold heading, countersunk hole processing, step drilling',
    'products.tubularRivetsTitle': 'Tubular Rivets',
    'products.tubularRivetsDesc': 'Fully hollow (tubular) rivets that provide maximum assembly flexibility. Used for lightweight joints in leather, plastics, printed circuit boards, and hinge connections.',
    'products.tubularRivetsItem1': 'Full Tubular Pipe Rivets (DIN 7338 Type B/C)',
    'products.tubularRivetsItem2': 'Custom Hollow Sleeves & Bushing Components',
    'products.tubularMaterials': 'Stainless Steel, Aluminum, Brass, Copper, Steel',
    'products.tubularSizes': 'Diameter: M3 - M8 (3mm - 8mm), Length: 4mm - 50mm',
    'products.tubularSpecOps': 'Hollow tube heading, secondary precision inside drilling, grooving',
    ...
    'quality.p1': 'At Özperçin Cıvata Sanayi, we operate under strict tolerances approaching zero-defect manufacturing. We meet dimensional and material requirements defined by DIN/ISO norms for standard lines as well as custom components.',
    ...
    'quality.machine3': 'Yield & Hardness Analysis',
    'quality.machine3Desc': 'Computer-assisted graphical analysis software for real-time tracking of test curves and hardness logging.',
